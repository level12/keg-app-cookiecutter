...
class DefaultProfile(object):
    ...
    KEGAUTH_RESET_ATTEMPT_LIMIT = KEGAUTH_FORGOT_ATTEMPT_LIMIT = \
        KEGAUTH_LOGIN_ATTEMPT_LIMIT = 15
    KEGAUTH_RESET_ATTEMPT_TIMESPAN = KEGAUTH_FORGOT_ATTEMPT_TIMESPAN = \
        KEGAUTH_LOGIN_ATTEMPT_TIMESPAN = 10 * 60
    # Lock for 60 minutes to clear.
    KEGAUTH_RESET_ATTEMPT_LOCKOUT = KEGAUTH_FORGOT_ATTEMPT_LOCKOUT = \
