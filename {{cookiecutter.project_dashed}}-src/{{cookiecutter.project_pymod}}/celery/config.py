...
def celery_config(broker_url, queue_name='celery'):
    """
    ...
    return {
        ...
        'task_queues': (
            kombu.Queue(queue_name, kombu.Exchange(queue_name), routing_key=queue_name,
        ...
        # rather than double-execute a wager task.
        #
